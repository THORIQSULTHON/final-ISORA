...
?>
	<div class="container">
		<div class="content">
			<?php 
			$nip = $_POST['carinip']; // mengambil nip dari form cari ?> 
			<h2>Pencarian Data Guru &raquo; NIP: <?php echo $nip; // menampilkan nip ?></h2>
			<hr />
			
			<?php
			$sql = mysqli_query($koneksi, "SELECT * FROM tb_guru WHERE nip= '$nip'"); // query untuk memilih entri dengan nip terpilih
